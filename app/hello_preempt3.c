...
{
	ucx_task_add(task0, DEFAULT_GUARD_SIZE, 4, 25);
	ucx_task_add(task1, DEFAULT_GUARD_SIZE, 3, 22);
	ucx_task_add(task2, DEFAULT_GUARD_SIZE, 2, 19);
	ucx_task_add(task3, DEFAULT_GUARD_SIZE, 1, 17);
	ucx_task_add(task4, DEFAULT_GUARD_SIZE, 2, 15);
	ucx_task_add(task5, DEFAULT_GUARD_SIZE, 1, 10);
	ucx_task_add(task6, DEFAULT_GUARD_SIZE, 1, 8);
	ucx_task_add(task7, DEFAULT_GUARD_SIZE, 0, 0);
	
	ucx_task_priority(7, TASK_LOW_PRIO);
